...
<html>
	<head>
        ...
        <script>
            function login() {
                ...
                xhr.open("post", "${pageContext.request.contextPath}/LoginServlet?timeStamp=" + new Date().getTime(), true);
	...
	<body>
		<div class="container">
			...
			<dl class="regliketab">
				<dt id="stu_zhuce" class="stu_zhuce on" onclick="window.location.href = 'stu_login.jsp'">
					<a href="#" id="">用户登录</a>
				</dt>
				<dt id="carer_zhuce" class="carer_zhuce" onclick="window.location.href = 'carer_login.jsp'">
					<a href="#" >司机登录</a>
				</dt>
			</dl>
			<div class="reg_form">
				<form method="post" action="" id="stu_form" name="stu_form">
					<dl class="dl_1">
						...
						<dd>
							<i>
								<input id="username" class="txt_input" type="text" placeholder="请输入您的用户名" name="username" style="background: url(img/icons8-性别中性用户-50.png) no-repeat;background-size: 18px 18px;background-position: 5px 6px;"/>
							</i>
							<span id="name_notice" class=""></span>
						</dd>
					</dl>
					<dl>
						<dt>
